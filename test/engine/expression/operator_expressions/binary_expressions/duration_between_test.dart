...
void durationBetweenTest() {
  group('DurationBetween', () {
    test(
        ...
        () {
      final low = LiteralDate(value: '2012-01-01');
      final high = LiteralDate(value: '2012-02-01');
    ...
    test(
        ...
        () {
      final low = LiteralDateTime(value: '2012-01-01T01:01:01');
      final high = LiteralDateTime(value: '2012-02-01T01:01:01');
      final duration = DurationBetween(
          precision: CqlDateTimePrecision.month, operand: [low, high]);
      expect(duration.execute({}), FhirInteger(1));
    });
    ...
    test(
        ...
        () {
      final low = LiteralDateTime(value: '2012-01-01T23:00:00');
      final high = LiteralDateTime(value: '2012-01-02T02:00:00');
      final duration = DurationBetween(

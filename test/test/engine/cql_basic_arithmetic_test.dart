...
void main() {
  ...
  group('Add', () {
    test('define "IntegerAdd": 2 + 2 // 4', () async {
      ...
      expect(await add.execute({}), CqlInteger(4));
    });
    ...
    test('define "DecimalAdd": 2.5 + 5.0 // 7.5', () async {
      ...
      expect(await add.execute({}), CqlDecimal(7.5));
    });
    ...
    test('define "MixedIntDecimalAdd": 2 + 3.5 // 5.5', () async {
      ...
      expect(await add.execute({}), CqlDecimal(5.5));
    });
  });
  ...
  group('Subtract', () {
    test('define "IntegerSubtract": 2 - 1 // 1', () async {
      ...
      expect(await sub.execute({}), CqlInteger(1));
    });
  ...
  group('Multiply', () {
    test('define "IntegerMultiply": 2 * 3 // 6', () async {
      ...
      expect(await mul.execute({}), CqlInteger(6));
    });
    ...
    test('define "DecimalMultiply": 2.5 * 4.0 // 10.0', () async {
      ...
      expect(await mul.execute({}), CqlDecimal(10.0));
    });
  ...
  group('Divide', () {
    test('define "IntegerDivide": 4.0 / 2 // 2.0', () async {
      ...
      expect(await div.execute({}), CqlDecimal(2.0));
    });
  ...
  group('TruncatedDivide', () {
    test('define "IntegerTruncatedDivide": 10 div 3 // 3', () async {
      ...
      expect(await div.execute({}), CqlInteger(3));
    });
  ...
  group('Modulo', () {
    test('define "IntegerModulo": 10 mod 3 // 1', () async {
      ...
      expect(await mod.execute({}), CqlInteger(1));
    });
  ...
  group('Power', () {
    test('define "IntegerPower": 2 ^ 3 // 8', () async {
      ...
      expect(await pow.execute({}), CqlInteger(8));
    });

...
abstract class CqlNumber extends CqlPrimitive
    implements Comparable<CqlNumber> {
  ...
  factory CqlNumber.fromNum({required num value}) =>
      value is int ? CqlInteger(value.toString()) : CqlDecimal(value.toString());

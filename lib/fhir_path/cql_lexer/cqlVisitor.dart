...
abstract class cqlVisitor<T> extends ParseTreeVisitor<T> {
  ...
  /// [ctx] the parse tree.
  /// Return the visitor result.
  T? visitQualifiedIdentifierExpression(QualifiedIdentifierExpressionContext ctx);
  ...
  /// [ctx] the parse tree.
  /// Return the visitor result.
  T? visitSimplePathQualifiedIdentifier(SimplePathQualifiedIdentifierContext ctx);

  /// Visit a parse tree produced by the {@code simplePathReferentialIdentifier}
  /// labeled alternative in {@link cqlParser#simplePath}.
  /// [ctx] the parse tree.
  /// Return the visitor result.
  T? visitSimplePathReferentialIdentifier(SimplePathReferentialIdentifierContext ctx);
  ...
  /// [ctx] the parse tree.
  /// Return the visitor result.
  T? visitElementExtractorExpressionTerm(ElementExtractorExpressionTermContext ctx);
  ...
  /// [ctx] the parse tree.
  /// Return the visitor result.
  T? visitConcurrentWithIntervalOperatorPhrase(ConcurrentWithIntervalOperatorPhraseContext ctx);

  /// Visit a parse tree produced by the {@code includesIntervalOperatorPhrase}
  /// labeled alternative in {@link cqlParser#intervalOperatorPhrase}.
  /// [ctx] the parse tree.
  /// Return the visitor result.
  T? visitIncludesIntervalOperatorPhrase(IncludesIntervalOperatorPhraseContext ctx);

  /// Visit a parse tree produced by the {@code includedInIntervalOperatorPhrase}
  /// labeled alternative in {@link cqlParser#intervalOperatorPhrase}.
  /// [ctx] the parse tree.
  /// Return the visitor result.
  T? visitIncludedInIntervalOperatorPhrase(IncludedInIntervalOperatorPhraseContext ctx);

  /// Visit a parse tree produced by the {@code beforeOrAfterIntervalOperatorPhrase}
  /// labeled alternative in {@link cqlParser#intervalOperatorPhrase}.
  /// [ctx] the parse tree.
  /// Return the visitor result.
  T? visitBeforeOrAfterIntervalOperatorPhrase(BeforeOrAfterIntervalOperatorPhraseContext ctx);
  ...
  /// [ctx] the parse tree.
  /// Return the visitor result.
  T? visitOverlapsIntervalOperatorPhrase(OverlapsIntervalOperatorPhraseContext ctx);
  ...
  /// [ctx] the parse tree.
  /// Return the visitor result.
  T? visitReferentialOrTypeNameIdentifier(ReferentialOrTypeNameIdentifierContext ctx);

  /// Visit a parse tree produced by [cqlParser.identifierOrFunctionIdentifier].
  /// [ctx] the parse tree.
  /// Return the visitor result.
  T? visitIdentifierOrFunctionIdentifier(IdentifierOrFunctionIdentifierContext ctx);

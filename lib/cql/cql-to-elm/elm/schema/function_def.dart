...
@JsonSerializable()
class FunctionDefs {
  List<FunctionDef> functions = <FunctionDef>[];

  FunctionDefs();

  factory FunctionDefs.fromJson(Map<String, dynamic> json) =>
      _$FunctionDefsFromJson(json);

  Map<String, dynamic> toJson() => _$FunctionDefsToJson(this);
}

const qdmmodelinfo53 = r'''<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<ns4:modelInfo name="QDM" url="urn:healthit-gov:qdm:v5_3" targetQualifier="qdm" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:ns4="urn:hl7-org:elm-modelinfo:r1" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
               patientClassName="QDM.Patient" patientClassIdentifier="Patient" patientBirthDatePropertyName="birthDatetime" version="5.3" strictRetrieveTyping="true">
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="QDM.Id" baseType="System.Any">
        <ns4:element name="namingSystem" type="System.String"/>
        <ns4:element name="value" type="System.String"/>
    </ns4:typeInfo>
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="QDM.Ratio" baseType="System.Any">
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="QDM.CareGoal" retrievable="true" baseType="QDM.QDMBaseType" label="Care Goal" primaryCodePath="code">
        ...
        <ns4:element name="relatedTo" type="list&lt;QDM.Id&gt;"/>
        <ns4:element name="targetOutcome"> <!--type="System.Any">-->
            <ns4:typeSpecifier xsi:type="ns4:ChoiceTypeSpecifier">
                ...
                <ns4:choice xsi:type="ns4:NamedTypeSpecifier" modelName="QDM" name="Ratio"/>
            </ns4:typeSpecifier>
        </ns4:element>
    </ns4:typeInfo>
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="QDM.EncounterPerformed" retrievable="false" baseType="QDM.QDMBaseType">
        ...
        <ns4:element name="diagnoses" type="list&lt;System.Code&gt;"/>
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="QDM.ProviderCharacteristic" retrievable="true" baseType="QDM.QDMBaseType" label="Provider Characteristic" primaryCodePath="code">
        <ns4:element name="authorDatetime" type="System.DateTime"/>
    </ns4:typeInfo>
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="QDM.QDMBaseType" retrievable="false" baseType="System.Any">
        <ns4:element name="id" type="QDM.Id"/>
        <ns4:element name="code" type="System.Code"/>
        <ns4:element name="patientId" type="QDM.Id"/>
        <ns4:element name="reporter" type="QDM.Id"/>
        <ns4:element name="recorder" type="QDM.Id"/>
    </ns4:typeInfo>

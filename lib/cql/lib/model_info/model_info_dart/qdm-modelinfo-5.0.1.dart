const qdmmodelinfo501 = r'''<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<ns4:modelInfo name="QDM" url="urn:healthit-gov:qdm:v5_0_1_draft" targetQualifier="qdm" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:ns4="urn:hl7-org:elm-modelinfo:r1" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
               patientClassName="QDM.Patient" patientClassIdentifier="Patient" patientBirthDatePropertyName="birthDatetime" version="5.0.1">
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="QDM.PatientCharacteristicSex" retrievable="true" baseType="QDM.QDMBaseType" label="Patient Characteristic Sex"/>
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="QDM.EncounterActive" retrievable="true" baseType="QDM.QDMBaseType" label="Encounter, Active">
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="QDM.CareGoal" retrievable="true" baseType="QDM.QDMBaseType" label="Care Goal">
        <ns4:element name="relevantPeriod" type="interval&lt;System.DateTime&gt;"/>
        <ns4:element name="relatedTo" type="System.Code"/>
        <ns4:element name="targetOutcome" type="System.Any"/>
    </ns4:typeInfo>
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="QDM.PatientCharacteristic" retrievable="true" baseType="QDM.QDMBaseType" label="Patient Characteristic">
        <ns4:element name="authorDatetime" type="System.DateTime"/>
    </ns4:typeInfo>
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="QDM.PatientCharacteristicEthnicity" retrievable="true" baseType="QDM.QDMBaseType" label="Patient Characteristic Ethnicity"/>
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="QDM.PatientCharacteristicRace" retrievable="true" baseType="QDM.QDMBaseType" label="Patient Characteristic Race"/>
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="QDM.Symptom" retrievable="true" baseType="QDM.QDMBaseType" label="Symptom">
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="QDM.PatientCharacteristicClinicalTrialParticipant" retrievable="true" baseType="QDM.QDMBaseType" label="Patient Characteristic Clinical Trial Participant">
        <ns4:element name="reason" type="System.Code"/>
        <ns4:element name="relevantPeriod" type="interval&lt;System.DateTime&gt;"/>
    </ns4:typeInfo>
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="QDM.FamilyHistory" retrievable="true" baseType="QDM.QDMBaseType" label="Family History">
        <ns4:element name="authorDatetime" type="System.DateTime"/>
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="QDM.MedicationActive" retrievable="true" baseType="QDM.QDMBaseType" label="Medication, Active">
        <ns4:element name="relevantPeriod" type="interval&lt;System.DateTime&gt;"/>
        <ns4:element name="dosage" type="System.Quantity"/>
        <ns4:element name="supply" type="System.Quantity"/>
        <ns4:element name="frequency" type="System.Code"/>
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="QDM.PatientCharacteristicPayer" retrievable="true" baseType="QDM.QDMBaseType" label="Patient Characteristic Payer">
        <ns4:element name="relevantPeriod" type="interval&lt;System.DateTime&gt;"/>
    </ns4:typeInfo>
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="QDM.PatientCharacteristicExpired" retrievable="true" baseType="QDM.QDMBaseType" label="Patient Characteristic Expired">
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="QDM.AllergyIntolerance" retrievable="true" baseType="QDM.QDMBaseType" label="Allergy/Intolerance">
        <ns4:element name="prevalencePeriod" type="interval&lt;System.DateTime&gt;"/>
        <ns4:element name="type" type="System.Code"/>
        <ns4:element name="severity" type="System.Code"/>
    </ns4:typeInfo>
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="QDM.ProviderCharacteristic" retrievable="true" baseType="QDM.QDMBaseType" label="Provider Characteristic">
        <ns4:element name="authorDatetime" type="System.DateTime"/>
    </ns4:typeInfo>
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="QDM.PatientCharacteristicBirthdate" retrievable="true" baseType="QDM.QDMBaseType" label="Patient Characteristic Birthdate">
        <ns4:element name="birthDatetime" type="System.DateTime"/>
    </ns4:typeInfo>
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="QDM.AdverseEvent" retrievable="true" baseType="QDM.QDMBaseType" label="Adverse Event">
        <ns4:element name="relevantPeriod" type="interval&lt;System.DateTime&gt;"/>
        <ns4:element name="severity" type="System.Code"/>
        <ns4:element name="facilityLocation" type="System.Code"/>
        <ns4:element name="type" type="System.Code"/>
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="QDM.QDMBaseType" retrievable="false" baseType="System.Any">
        <ns4:element name="id" type="System.Code"/>
        <ns4:element name="code" type="System.Code"/>
        <ns4:element name="patientId" type="System.Code"/>
        <ns4:element name="reporter" type="System.Code"/>
        <ns4:element name="recorder" type="System.Code"/>
    </ns4:typeInfo>
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="QDM.PatientCareExperience" retrievable="true" baseType="QDM.QDMBaseType" label="Patient Care Experience">
        <ns4:element name="authorDatetime" type="System.DateTime"/>
    </ns4:typeInfo>
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="QDM.ProviderCareExperience" retrievable="true" baseType="QDM.QDMBaseType" label="Provider Care Experience">
        <ns4:element name="authorDatetime" type="System.DateTime"/>
    </ns4:typeInfo>
    ...
    <ns4:typeInfo xsi:type="ns4:ProfileInfo" name="QDM.PositiveCommunicationFromPatientToProvider" retrievable="true" baseType="QDM.CommunicationFromPatientToProvider" identifier="PositiveCommunicationFromPatientToProvider" label="Communication: From Patient To Provider" primaryCodePath="code"/>
    <ns4:typeInfo xsi:type="ns4:ProfileInfo" name="QDM.NegativeCommunicationFromPatientToProvider" retrievable="true" baseType="QDM.CommunicationFromPatientToProvider" identifier="NegativeCommunicationFromPatientToProvider" label="Communication: From Patient To Provider, Not Done" primaryCodePath="code"/>
    <ns4:typeInfo xsi:type="ns4:ProfileInfo" name="QDM.PositiveCommunicationFromProviderToPatient" retrievable="true" baseType="QDM.CommunicationFromProviderToPatient" identifier="PositiveCommunicationFromProviderToPatient" label="Communication: From Provider To Patient" primaryCodePath="code"/>
    <ns4:typeInfo xsi:type="ns4:ProfileInfo" name="QDM.NegativeCommunicationFromProviderToPatient" retrievable="true" baseType="QDM.CommunicationFromProviderToPatient" identifier="NegativeCommunicationFromProviderToPatient" label="Communication: From Provider To Patient, Not Done" primaryCodePath="code"/>
    <ns4:typeInfo xsi:type="ns4:ProfileInfo" name="QDM.PositiveCommunicationFromProviderToProvider" retrievable="true" baseType="QDM.CommunicationFromProviderToProvider" identifier="PositiveCommunicationFromProviderToProvider" label="Communication: From Provider To Provider" primaryCodePath="code"/>
    <ns4:typeInfo xsi:type="ns4:ProfileInfo" name="QDM.NegativeCommunicationFromProviderToProvider" retrievable="true" baseType="QDM.CommunicationFromProviderToProvider" identifier="NegativeCommunicationFromProviderToProvider" label="Communication: From Provider To Provider, Not Done" primaryCodePath="code"/>
    ...
    <ns4:typeInfo xsi:type="ns4:ProfileInfo" name="QDM.PositiveDeviceApplied" retrievable="true" baseType="QDM.DeviceApplied" identifier="PositiveDeviceApplied" label="Device, Applied" primaryCodePath="code"/>
    <ns4:typeInfo xsi:type="ns4:ProfileInfo" name="QDM.NegativeDeviceApplied" retrievable="true" baseType="QDM.DeviceApplied" identifier="NegativeDeviceApplied" label="Device, Not Applied" primaryCodePath="code"/>
    ...
    <ns4:typeInfo xsi:type="ns4:ProfileInfo" name="QDM.NegativeEncounterPerformed" retrievable="true" baseType="QDM.EncounterPerformed" identifier="NegativeEncounterPerformed" label="Encounter, Not Performed" primaryCodePath="code"/>

const libraryomtkmodelinfoomtkmodelinfo = r'''<?xml version="1.0" encoding="UTF-8"?><Library xmlns="http://hl7.org/fhir">
  <id value="omtk-modelinfo"/>
  <meta>
    <security>
  ...
  <identifier>
    <use value="official"/>
    <value value="OMTKModelInfo"/>
  </identifier>
  <version value="0.1.0"/>
  <name value="OMTKModelInfo"/>
  <title value="OMTK Model Info"/>
  <status value="active"/>
  ...
  <description value="Opioid Management Terminology Knowledge Base Model Definition for use in implementing CDC Opioid Prescribing Guidelines."/>
  <useContext>
    <code>
  ...
  <purpose value="This library defines the Opioid Management Terminology Knowledge Base model"/>
  <usage value="This library is used to resolve data elements in the Opioid Management Terminology Knowledge Base model"/>

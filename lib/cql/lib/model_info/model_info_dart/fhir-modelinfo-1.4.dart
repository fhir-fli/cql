const fhirmodelinfo14 = r'''<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<ns4:modelInfo name="FHIR" version="1.4" url="http://hl7.org/fhir" targetQualifier="fhir" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:ns4="urn:hl7-org:elm-modelinfo:r1" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" patientClassName="FHIR.Patient" patientBirthDatePropertyName="birthDate.value" schemaLocation="http://org.hl7.fhir fhir-single.xsd">
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="FHIR.ImagingExcerpt.Viewable" retrievable="false" baseType="FHIR.BackboneElement">
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="FHIR.GuidanceResponse.Action" retrievable="false" baseType="FHIR.BackboneElement">
        ...
        <ns4:element name="supportingEvidence" type="list&lt;FHIR.Attachment&gt;"/>
        <ns4:element name="relatedAction" type="FHIR.GuidanceResponse.RelatedAction"/>
        <ns4:element name="documentation" type="list&lt;FHIR.Attachment&gt;"/>
        <ns4:element name="participant" type="list&lt;FHIR.Reference&gt;"/>
        <ns4:element name="type" type="FHIR.code"/>
        <ns4:element name="behavior" type="list&lt;FHIR.GuidanceResponse.Behavior&gt;"/>
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="FHIR.StructureDefinition" retrievable="true" baseType="FHIR.DomainResource">
        ...
        <ns4:element name="baseType" type="FHIR.code"/>
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="FHIR.ExplanationOfBenefit.SubDetail" retrievable="false" baseType="FHIR.BackboneElement">
        ...
        <ns4:element name="net" type="FHIR.Money"/>
        <ns4:element name="udi" type="list&lt;FHIR.Reference&gt;"/>
        <ns4:element name="adjudication" type="list&lt;FHIR.ExplanationOfBenefit.Adjudication2&gt;"/>
    </ns4:typeInfo>
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="FHIR.ImagingObjectSelection.Frame" retrievable="false" baseType="FHIR.BackboneElement">
        <ns4:element name="number" type="list&lt;FHIR.unsignedInt&gt;"/>
        <ns4:element name="url" type="FHIR.uri"/>
    </ns4:typeInfo>
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="FHIR.Task.Input" retrievable="false" baseType="FHIR.BackboneElement">
        ...
        <ns4:element name="valueModuleMetadata" type="FHIR.ModuleMetadata"/>
        <ns4:element name="valueDataRequirement" type="FHIR.DataRequirement"/>
        <ns4:element name="valueActionDefinition" type="FHIR.ActionDefinition"/>
        <ns4:element name="valueParameterDefinition" type="FHIR.ParameterDefinition"/>
        <ns4:element name="valueTriggerDefinition" type="FHIR.TriggerDefinition"/>
    </ns4:typeInfo>
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="FHIR.Library.CodeSystem" retrievable="false" baseType="FHIR.BackboneElement">
        <ns4:element name="name" type="FHIR.string"/>
        <ns4:element name="identifier" type="FHIR.string"/>
        <ns4:element name="version" type="FHIR.string"/>
    </ns4:typeInfo>
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="FHIR.GuidanceResponse" retrievable="true" baseType="FHIR.DomainResource">
        <ns4:element name="requestId" type="FHIR.string"/>
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="FHIR.Protocol" retrievable="true" baseType="FHIR.DomainResource" primaryCodePath="type">
        <ns4:element name="identifier" type="list&lt;FHIR.Identifier&gt;"/>
        <ns4:element name="title" type="FHIR.string"/>
        <ns4:element name="status" type="FHIR.ProtocolStatus"/>
        <ns4:element name="type" type="FHIR.ProtocolType"/>
        <ns4:element name="subject" type="FHIR.Reference"/>
        <ns4:element name="group" type="FHIR.Reference"/>
        <ns4:element name="purpose" type="FHIR.string"/>
        <ns4:element name="author" type="FHIR.Reference"/>
        <ns4:element name="step" type="list&lt;FHIR.Protocol.Step&gt;"/>
    </ns4:typeInfo>
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="FHIR.ProtocolStatus" retrievable="false" baseType="FHIR.Element">
        <ns4:element name="value" type="System.String"/>
    </ns4:typeInfo>
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="FHIR.ModuleMetadata.Contact1" retrievable="false" baseType="FHIR.Element">
        <ns4:element name="name" type="FHIR.string"/>
        <ns4:element name="telecom" type="list&lt;FHIR.ContactPoint&gt;"/>
    </ns4:typeInfo>
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="FHIR.ModuleDefinition.DateFilter" retrievable="false" baseType="FHIR.BackboneElement">
        <ns4:element name="path" type="FHIR.string"/>
        <ns4:element name="valueDateTime" type="FHIR.dateTime"/>
        <ns4:element name="valuePeriod" type="FHIR.Period"/>
    </ns4:typeInfo>
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="FHIR.ImagingObjectSelection.Instance" retrievable="false" baseType="FHIR.BackboneElement">
        ...
        <ns4:element name="uid" type="FHIR.oid"/>
        <ns4:element name="url" type="FHIR.uri"/>
        <ns4:element name="frame" type="list&lt;FHIR.ImagingObjectSelection.Frame&gt;"/>
    </ns4:typeInfo>
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="FHIR.ActionDefinition" retrievable="false" baseType="FHIR.Element">
        <ns4:element name="actionIdentifier" type="FHIR.Identifier"/>
        <ns4:element name="label" type="FHIR.string"/>
        <ns4:element name="title" type="FHIR.string"/>
        <ns4:element name="description" type="FHIR.string"/>
        ...
        <ns4:element name="supportingEvidence" type="list&lt;FHIR.Attachment&gt;"/>
        <ns4:element name="documentation" type="list&lt;FHIR.Attachment&gt;"/>
        <ns4:element name="relatedAction" type="FHIR.ActionDefinition.RelatedAction"/>
        <ns4:element name="participantType" type="list&lt;FHIR.ParticipantType&gt;"/>
        <ns4:element name="type" type="FHIR.ActionType"/>
        <ns4:element name="behavior" type="list&lt;FHIR.ActionDefinition.Behavior&gt;"/>
        <ns4:element name="resource" type="FHIR.Reference"/>
        <ns4:element name="customization" type="list&lt;FHIR.ActionDefinition.Customization&gt;"/>
        <ns4:element name="action" type="list&lt;FHIR.ActionDefinition&gt;"/>
    </ns4:typeInfo>
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="FHIR.ExplanationOfBenefit.Detail" retrievable="false" baseType="FHIR.BackboneElement">
        ...
        <ns4:element name="net" type="FHIR.Money"/>
        <ns4:element name="udi" type="list&lt;FHIR.Reference&gt;"/>
        <ns4:element name="adjudication" type="list&lt;FHIR.ExplanationOfBenefit.Adjudication1&gt;"/>
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="FHIR.ModuleDefinition.Data" retrievable="false" baseType="FHIR.BackboneElement">
        <ns4:element name="type" type="FHIR.code"/>
        <ns4:element name="profile" type="FHIR.Reference"/>
        <ns4:element name="mustSupport" type="list&lt;FHIR.string&gt;"/>
        <ns4:element name="codeFilter" type="list&lt;FHIR.ModuleDefinition.CodeFilter&gt;"/>
        <ns4:element name="dateFilter" type="list&lt;FHIR.ModuleDefinition.DateFilter&gt;"/>
    </ns4:typeInfo>
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="FHIR.ImagingExcerpt.Series" retrievable="false" baseType="FHIR.BackboneElement">
        <ns4:element name="uid" type="FHIR.oid"/>
        <ns4:element name="dicom" type="list&lt;FHIR.ImagingExcerpt.Dicom1&gt;"/>
        <ns4:element name="instance" type="list&lt;FHIR.ImagingExcerpt.Instance&gt;"/>
    </ns4:typeInfo>
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="FHIR.Measure" retrievable="true" baseType="FHIR.DomainResource">
        <ns4:element name="moduleMetadata" type="FHIR.ModuleMetadata"/>
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="FHIR.ExplanationOfBenefit" retrievable="true" baseType="FHIR.DomainResource">
        ...
        <ns4:element name="occurrenceCode" type="list&lt;FHIR.Coding&gt;"/>
        <ns4:element name="occurenceSpanCode" type="list&lt;FHIR.Coding&gt;"/>
        <ns4:element name="valueCode" type="list&lt;FHIR.Coding&gt;"/>
        ...
        <ns4:element name="specialCondition" type="list&lt;FHIR.Coding&gt;"/>
        ...
        <ns4:element name="accidentDate" type="FHIR.date"/>
        <ns4:element name="accidentType" type="FHIR.Coding"/>
        <ns4:element name="accidentLocationAddress" type="FHIR.Address"/>
        <ns4:element name="accidentLocationReference" type="FHIR.Reference"/>
        <ns4:element name="interventionException" type="list&lt;FHIR.Coding&gt;"/>
        <ns4:element name="onset" type="list&lt;FHIR.ExplanationOfBenefit.Onset&gt;"/>
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="FHIR.Claim.Item" retrievable="false" baseType="FHIR.BackboneElement">
        ...
        <ns4:element name="providerIdentifier" type="FHIR.Identifier"/>
        <ns4:element name="providerReference" type="FHIR.Reference"/>
        <ns4:element name="supervisorIdentifier" type="FHIR.Identifier"/>
        <ns4:element name="supervisorReference" type="FHIR.Reference"/>
        <ns4:element name="providerQualification" type="FHIR.Coding"/>
        <ns4:element name="diagnosisLinkId" type="list&lt;FHIR.positiveInt&gt;"/>
        <ns4:element name="service" type="FHIR.Coding"/>
        <ns4:element name="serviceModifier" type="list&lt;FHIR.Coding&gt;"/>
        ...
        <ns4:element name="place" type="FHIR.Coding"/>
        <ns4:element name="quantity" type="FHIR.SimpleQuantity"/>
        <ns4:element name="unitPrice" type="FHIR.Money"/>
        <ns4:element name="factor" type="FHIR.decimal"/>
        <ns4:element name="points" type="FHIR.decimal"/>
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="FHIR.ExplanationOfBenefit.Financial" retrievable="false" baseType="FHIR.BackboneElement">
        ...
        <ns4:element name="benefitQuantity" type="FHIR.Money"/>
        <ns4:element name="benefitUsedUnsignedInt" type="FHIR.unsignedInt"/>
        <ns4:element name="benefitUsedQuantity" type="FHIR.Money"/>
    </ns4:typeInfo>
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="FHIR.ImagingExcerpt.Study" retrievable="false" baseType="FHIR.BackboneElement">
        <ns4:element name="uid" type="FHIR.oid"/>
        <ns4:element name="imagingStudy" type="FHIR.Reference"/>
        <ns4:element name="dicom" type="list&lt;FHIR.ImagingExcerpt.Dicom&gt;"/>
        <ns4:element name="viewable" type="list&lt;FHIR.ImagingExcerpt.Viewable&gt;"/>
        <ns4:element name="series" type="list&lt;FHIR.ImagingExcerpt.Series&gt;"/>
    </ns4:typeInfo>
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="FHIR.Protocol.Component" retrievable="false" baseType="FHIR.BackboneElement">
        <ns4:element name="sequence" type="FHIR.integer"/>
        <ns4:element name="activity" type="FHIR.uri"/>
    </ns4:typeInfo>
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="FHIR.ModuleMetadata.RelatedResource" retrievable="false" baseType="FHIR.Element">
        <ns4:element name="type" type="FHIR.ModuleMetadataResourceType"/>
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="FHIR.Claim.Onset" retrievable="false" baseType="FHIR.BackboneElement">
        <ns4:element name="timeDate" type="FHIR.date"/>
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="FHIR.Protocol.Condition" retrievable="false" baseType="FHIR.BackboneElement">
        <ns4:element name="type" type="FHIR.CodeableConcept"/>
        <ns4:element name="valueCodeableConcept" type="FHIR.CodeableConcept"/>
        <ns4:element name="valueBoolean" type="FHIR.boolean"/>
        <ns4:element name="valueQuantity" type="FHIR.SimpleQuantity"/>
        <ns4:element name="valueRange" type="FHIR.Range"/>
    </ns4:typeInfo>
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="FHIR.ActionRelationshipType" retrievable="false" baseType="FHIR.Element">
        <ns4:element name="value" type="System.String"/>
    </ns4:typeInfo>
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="FHIR.Protocol.Activity" retrievable="false" baseType="FHIR.BackboneElement">
        <ns4:element name="alternative" type="list&lt;FHIR.uri&gt;"/>
        <ns4:element name="component" type="list&lt;FHIR.Protocol.Component&gt;"/>
        <ns4:element name="following" type="list&lt;FHIR.uri&gt;"/>
        <ns4:element name="wait" type="FHIR.Duration"/>
        <ns4:element name="detail" type="FHIR.Protocol.Detail"/>
    </ns4:typeInfo>
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="FHIR.ActionDefinition.Customization" retrievable="false" baseType="FHIR.Element">
        <ns4:element name="path" type="FHIR.string"/>
        <ns4:element name="expression" type="FHIR.string"/>
    </ns4:typeInfo>
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="FHIR.Library.Library" retrievable="false" baseType="FHIR.BackboneElement">
        <ns4:element name="name" type="FHIR.string"/>
        <ns4:element name="identifier" type="FHIR.string"/>
        <ns4:element name="version" type="FHIR.string"/>
        <ns4:element name="documentAttachment" type="FHIR.Attachment"/>
        <ns4:element name="documentReference" type="FHIR.Reference"/>
    </ns4:typeInfo>
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="FHIR.Sequence.StructureVariation" retrievable="false" baseType="FHIR.BackboneElement">
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="FHIR.ModuleMetadataType" retrievable="false" baseType="FHIR.Element">
        <ns4:element name="value" type="System.String"/>
    </ns4:typeInfo>
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="FHIR.ExplanationOfBenefit.Adjudication1" retrievable="false" baseType="FHIR.BackboneElement">
        <ns4:element name="category" type="FHIR.Coding"/>
        <ns4:element name="reason" type="FHIR.Coding"/>
        <ns4:element name="amount" type="FHIR.Money"/>
        <ns4:element name="value" type="FHIR.decimal"/>
    </ns4:typeInfo>
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="FHIR.ExplanationOfBenefit.Adjudication2" retrievable="false" baseType="FHIR.BackboneElement">
        <ns4:element name="category" type="FHIR.Coding"/>
        <ns4:element name="reason" type="FHIR.Coding"/>
        <ns4:element name="amount" type="FHIR.Money"/>
        <ns4:element name="value" type="FHIR.decimal"/>
    </ns4:typeInfo>
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="FHIR.ImagingExcerpt.Dicom" retrievable="false" baseType="FHIR.BackboneElement">
        <ns4:element name="type" type="FHIR.dWebType"/>
        <ns4:element name="url" type="FHIR.uri"/>
    </ns4:typeInfo>
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="FHIR.ExplanationOfBenefit.Adjudication3" retrievable="false" baseType="FHIR.BackboneElement">
        <ns4:element name="category" type="FHIR.Coding"/>
        <ns4:element name="reason" type="FHIR.Coding"/>
        <ns4:element name="amount" type="FHIR.Money"/>
        <ns4:element name="value" type="FHIR.decimal"/>
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="FHIR.ExplanationOfBenefit.Adjudication4" retrievable="false" baseType="FHIR.BackboneElement">
        <ns4:element name="category" type="FHIR.Coding"/>
        <ns4:element name="reason" type="FHIR.Coding"/>
        <ns4:element name="amount" type="FHIR.Money"/>
        <ns4:element name="value" type="FHIR.decimal"/>
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="FHIR.ImagingExcerpt.Dicom1" retrievable="false" baseType="FHIR.BackboneElement">
        <ns4:element name="type" type="FHIR.dWebType"/>
        <ns4:element name="url" type="FHIR.uri"/>
    </ns4:typeInfo>
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="FHIR.Sequence.Quality" retrievable="false" baseType="FHIR.BackboneElement">
        ...
        <ns4:element name="method" type="FHIR.string"/>
    </ns4:typeInfo>
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="FHIR.Sequence.Outer" retrievable="false" baseType="FHIR.BackboneElement">
        <ns4:element name="start" type="FHIR.integer"/>
        <ns4:element name="end" type="FHIR.integer"/>
    </ns4:typeInfo>
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="FHIR.ImagingExcerpt.Dicom2" retrievable="false" baseType="FHIR.BackboneElement">
        <ns4:element name="type" type="FHIR.dWebType"/>
        <ns4:element name="url" type="FHIR.uri"/>
    </ns4:typeInfo>
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="FHIR.PaymentReconciliation.Detail" retrievable="false" baseType="FHIR.BackboneElement">
        ...
        <ns4:element name="requestIdentifier" type="FHIR.Identifier"/>
        <ns4:element name="requestReference" type="FHIR.Reference"/>
        <ns4:element name="responceIdentifier" type="FHIR.Identifier"/>
        <ns4:element name="responceReference" type="FHIR.Reference"/>
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="FHIR.Task" retrievable="true" baseType="FHIR.DomainResource">
        <ns4:element name="identifier" type="FHIR.Identifier"/>
        <ns4:element name="type" type="FHIR.CodeableConcept"/>
        <ns4:element name="description" type="FHIR.string"/>
        <ns4:element name="performerType" type="list&lt;FHIR.Coding&gt;"/>
        <ns4:element name="priority" type="FHIR.TaskPriority"/>
        <ns4:element name="status" type="FHIR.TaskStatus"/>
        <ns4:element name="failureReason" type="FHIR.CodeableConcept"/>
        <ns4:element name="subject" type="FHIR.Reference"/>
        <ns4:element name="for" type="FHIR.Reference"/>
        <ns4:element name="definition" type="FHIR.uri"/>
        <ns4:element name="created" type="FHIR.dateTime"/>
        <ns4:element name="lastModified" type="FHIR.dateTime"/>
        <ns4:element name="creator" type="FHIR.Reference"/>
        <ns4:element name="owner" type="FHIR.Reference"/>
        <ns4:element name="parent" type="FHIR.Reference"/>
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="FHIR.Sequence" retrievable="true" baseType="FHIR.DomainResource">
        ...
        <ns4:element name="referenceSeq" type="list&lt;FHIR.Sequence.ReferenceSeq&gt;"/>
        <ns4:element name="variation" type="FHIR.Sequence.Variation"/>
        <ns4:element name="quality" type="list&lt;FHIR.Sequence.Quality&gt;"/>
        <ns4:element name="allelicState" type="FHIR.CodeableConcept"/>
        <ns4:element name="allelicFrequency" type="FHIR.decimal"/>
        <ns4:element name="copyNumberEvent" type="FHIR.CodeableConcept"/>
        ...
        <ns4:element name="observation" type="FHIR.Reference"/>
        <ns4:element name="structureVariation" type="FHIR.Sequence.StructureVariation"/>
    </ns4:typeInfo>
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="FHIR.ModuleDefinition" retrievable="true" baseType="FHIR.DomainResource">
        <ns4:element name="identifier" type="list&lt;FHIR.Identifier&gt;"/>
        <ns4:element name="version" type="FHIR.string"/>
        <ns4:element name="model" type="list&lt;FHIR.ModuleDefinition.Model&gt;"/>
        <ns4:element name="library" type="list&lt;FHIR.ModuleDefinition.Library&gt;"/>
        <ns4:element name="codeSystem" type="list&lt;FHIR.ModuleDefinition.CodeSystem&gt;"/>
        <ns4:element name="valueSet" type="list&lt;FHIR.ModuleDefinition.ValueSet&gt;"/>
        <ns4:element name="parameter" type="list&lt;FHIR.ModuleDefinition.Parameter&gt;"/>
        <ns4:element name="data" type="list&lt;FHIR.ModuleDefinition.Data&gt;"/>
    </ns4:typeInfo>
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="FHIR.dWebType" retrievable="false" baseType="FHIR.Element">
        <ns4:element name="value" type="System.String"/>
    </ns4:typeInfo>
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="FHIR.ImagingExcerpt" retrievable="true" baseType="FHIR.DomainResource">
        <ns4:element name="uid" type="FHIR.oid"/>
        <ns4:element name="patient" type="FHIR.Reference"/>
        <ns4:element name="authoringTime" type="FHIR.dateTime"/>
        <ns4:element name="author" type="FHIR.Reference"/>
        <ns4:element name="title" type="FHIR.CodeableConcept"/>
        <ns4:element name="description" type="FHIR.string"/>
        <ns4:element name="study" type="list&lt;FHIR.ImagingExcerpt.Study&gt;"/>
    </ns4:typeInfo>
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="FHIR.Protocol.Next" retrievable="false" baseType="FHIR.BackboneElement">
        <ns4:element name="description" type="FHIR.string"/>
        <ns4:element name="reference" type="FHIR.uri"/>
        <ns4:element name="condition" type="FHIR.Protocol.Precondition"/>
    </ns4:typeInfo>
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="FHIR.Library" retrievable="true" baseType="FHIR.DomainResource">
        <ns4:element name="moduleMetadata" type="FHIR.ModuleMetadata"/>
        <ns4:element name="model" type="list&lt;FHIR.Library.Model&gt;"/>
        <ns4:element name="library" type="list&lt;FHIR.Library.Library&gt;"/>
        <ns4:element name="codeSystem" type="list&lt;FHIR.Library.CodeSystem&gt;"/>
        <ns4:element name="valueSet" type="list&lt;FHIR.Library.ValueSet&gt;"/>
        <ns4:element name="parameter" type="list&lt;FHIR.ParameterDefinition&gt;"/>
        <ns4:element name="dataRequirement" type="list&lt;FHIR.DataRequirement&gt;"/>
        <ns4:element name="document" type="FHIR.Attachment"/>
    </ns4:typeInfo>
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="FHIR.ModuleMetadataContributorType" retrievable="false" baseType="FHIR.Element">
        <ns4:element name="value" type="System.String"/>
    </ns4:typeInfo>
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="FHIR.ExplanationOfBenefit.Detail1" retrievable="false" baseType="FHIR.BackboneElement">
        <ns4:element name="service" type="FHIR.Coding"/>
        <ns4:element name="fee" type="FHIR.Money"/>
        <ns4:element name="adjudication" type="list&lt;FHIR.ExplanationOfBenefit.Adjudication4&gt;"/>
    </ns4:typeInfo>
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="FHIR.Protocol.Step" retrievable="false" baseType="FHIR.BackboneElement">
        <ns4:element name="name" type="FHIR.string"/>
        <ns4:element name="description" type="FHIR.string"/>
        <ns4:element name="duration" type="FHIR.Duration"/>
        <ns4:element name="precondition" type="FHIR.Protocol.Precondition"/>
        <ns4:element name="exit" type="FHIR.Protocol.Precondition"/>
        <ns4:element name="firstActivity" type="FHIR.uri"/>
        <ns4:element name="activity" type="list&lt;FHIR.Protocol.Activity&gt;"/>
        <ns4:element name="next" type="list&lt;FHIR.Protocol.Next&gt;"/>
    </ns4:typeInfo>
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="FHIR.ModuleDefinition.CodeFilter" retrievable="false" baseType="FHIR.BackboneElement">
        <ns4:element name="path" type="FHIR.string"/>
        <ns4:element name="valueSetString" type="FHIR.string"/>
        <ns4:element name="valueSetReference" type="FHIR.Reference"/>
        <ns4:element name="codeableConcept" type="list&lt;FHIR.CodeableConcept&gt;"/>
    </ns4:typeInfo>
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="FHIR.ModuleDefinition.Parameter" retrievable="false" baseType="FHIR.BackboneElement">
        <ns4:element name="name" type="FHIR.code"/>
        <ns4:element name="use" type="FHIR.code"/>
        <ns4:element name="documentation" type="FHIR.string"/>
        <ns4:element name="type" type="FHIR.code"/>
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="FHIR.ResourceContainer" retrievable="false" baseType="System.Any">
        ...
        <ns4:element name="DecisionSupportRule" type="FHIR.DecisionSupportRule"/>
        ...
        <ns4:element name="ImagingExcerpt" type="FHIR.ImagingExcerpt"/>
        ...
        <ns4:element name="ModuleDefinition" type="FHIR.ModuleDefinition"/>
        ...
        <ns4:element name="OrderSet" type="FHIR.OrderSet"/>
        ...
        <ns4:element name="Protocol" type="FHIR.Protocol"/>
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="FHIR.Protocol.Precondition" retrievable="false" baseType="FHIR.BackboneElement">
        <ns4:element name="description" type="FHIR.string"/>
        <ns4:element name="condition" type="FHIR.Protocol.Condition"/>
        <ns4:element name="intersection" type="list&lt;FHIR.Protocol.Precondition&gt;"/>
        <ns4:element name="union" type="list&lt;FHIR.Protocol.Precondition&gt;"/>
        <ns4:element name="exclude" type="list&lt;FHIR.Protocol.Precondition&gt;"/>
    </ns4:typeInfo>
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="FHIR.ProtocolType" retrievable="false" baseType="FHIR.Element">
        <ns4:element name="value" type="System.String"/>
    </ns4:typeInfo>
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="FHIR.GuidanceResponse.RelatedAction" retrievable="false" baseType="FHIR.BackboneElement">
        ...
        <ns4:element name="offsetQuantity" type="FHIR.Duration"/>
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="FHIR.Binary" retrievable="true" baseType="FHIR.Resource">
        <ns4:element name="contentType" type="FHIR.code"/>
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="FHIR.ModuleMetadata.Coverage" retrievable="false" baseType="FHIR.Element">
        <ns4:element name="focus" type="FHIR.Coding"/>
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="FHIR.DiagnosticOrder" retrievable="true" baseType="FHIR.DomainResource" primaryCodePath="item.code">
        <ns4:element name="identifier" type="list&lt;FHIR.Identifier&gt;"/>
        <ns4:element name="status" type="FHIR.DiagnosticOrderStatus"/>
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="FHIR.ExplanationOfBenefit.Onset" retrievable="false" baseType="FHIR.BackboneElement">
        <ns4:element name="timeDate" type="FHIR.date"/>
        <ns4:element name="timePeriod" type="FHIR.Period"/>
        <ns4:element name="type" type="FHIR.Coding"/>
    </ns4:typeInfo>
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="FHIR.Questionnaire.EnableWhen" retrievable="false" baseType="FHIR.BackboneElement">
        ...
        <ns4:element name="answered" type="FHIR.boolean"/>
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="FHIR.ModuleMetadata" retrievable="false" baseType="FHIR.Element">
        <ns4:element name="url" type="FHIR.uri"/>
        <ns4:element name="identifier" type="list&lt;FHIR.Identifier&gt;"/>
        <ns4:element name="version" type="FHIR.string"/>
        <ns4:element name="name" type="FHIR.string"/>
        <ns4:element name="title" type="FHIR.string"/>
        <ns4:element name="type" type="FHIR.ModuleMetadataType"/>
        <ns4:element name="status" type="FHIR.ModuleMetadataStatus"/>
        <ns4:element name="experimental" type="FHIR.boolean"/>
        <ns4:element name="description" type="FHIR.string"/>
        <ns4:element name="purpose" type="FHIR.string"/>
        <ns4:element name="usage" type="FHIR.string"/>
        ...
        <ns4:element name="effectivePeriod" type="FHIR.Period"/>
        <ns4:element name="coverage" type="list&lt;FHIR.ModuleMetadata.Coverage&gt;"/>
        <ns4:element name="topic" type="list&lt;FHIR.CodeableConcept&gt;"/>
        <ns4:element name="contributor" type="list&lt;FHIR.ModuleMetadata.Contributor&gt;"/>
        <ns4:element name="publisher" type="FHIR.string"/>
        <ns4:element name="contact" type="list&lt;FHIR.ModuleMetadata.Contact&gt;"/>
        <ns4:element name="copyright" type="FHIR.string"/>
        <ns4:element name="relatedResource" type="list&lt;FHIR.ModuleMetadata.RelatedResource&gt;"/>
    </ns4:typeInfo>
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="FHIR.ExplanationOfBenefit.AddItem" retrievable="false" baseType="FHIR.BackboneElement">
        ...
        <ns4:element name="fee" type="FHIR.Money"/>
        <ns4:element name="noteNumberLinkId" type="list&lt;FHIR.positiveInt&gt;"/>
        <ns4:element name="adjudication" type="list&lt;FHIR.ExplanationOfBenefit.Adjudication3&gt;"/>
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="FHIR.ModuleMetadataResourceType" retrievable="false" baseType="FHIR.Element">
        <ns4:element name="value" type="System.String"/>
    </ns4:typeInfo>
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="FHIR.ModuleDefinition.CodeSystem" retrievable="false" baseType="FHIR.BackboneElement">
        <ns4:element name="name" type="FHIR.string"/>
        <ns4:element name="identifier" type="FHIR.string"/>
        <ns4:element name="version" type="FHIR.string"/>
    </ns4:typeInfo>
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="FHIR.ModuleDefinition.Model" retrievable="false" baseType="FHIR.BackboneElement">
        <ns4:element name="name" type="FHIR.string"/>
        <ns4:element name="identifier" type="FHIR.string"/>
        <ns4:element name="version" type="FHIR.string"/>
    </ns4:typeInfo>
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="FHIR.ModuleMetadata.Contact" retrievable="false" baseType="FHIR.Element">
        <ns4:element name="name" type="FHIR.string"/>
        <ns4:element name="telecom" type="list&lt;FHIR.ContactPoint&gt;"/>
    </ns4:typeInfo>
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="FHIR.Sequence.Variation" retrievable="false" baseType="FHIR.BackboneElement">
        <ns4:element name="start" type="FHIR.integer"/>
        <ns4:element name="end" type="FHIR.integer"/>
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="FHIR.OrderSet" retrievable="true" baseType="FHIR.DomainResource">
        <ns4:element name="moduleMetadata" type="FHIR.ModuleMetadata"/>
        <ns4:element name="library" type="list&lt;FHIR.Reference&gt;"/>
        <ns4:element name="action" type="list&lt;FHIR.ActionDefinition&gt;"/>
    </ns4:typeInfo>
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="FHIR.ModuleMetadataStatus" retrievable="false" baseType="FHIR.Element">
        <ns4:element name="value" type="System.String"/>
    </ns4:typeInfo>
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="FHIR.ModuleMetadata.Contributor" retrievable="false" baseType="FHIR.Element">
        <ns4:element name="type" type="FHIR.ModuleMetadataContributorType"/>
        <ns4:element name="name" type="FHIR.string"/>
        <ns4:element name="contact" type="list&lt;FHIR.ModuleMetadata.Contact1&gt;"/>
    </ns4:typeInfo>
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="FHIR.ImagingExcerpt.Instance" retrievable="false" baseType="FHIR.BackboneElement">
        <ns4:element name="sopClass" type="FHIR.oid"/>
        <ns4:element name="uid" type="FHIR.oid"/>
        <ns4:element name="dicom" type="list&lt;FHIR.ImagingExcerpt.Dicom2&gt;"/>
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="FHIR.DecisionSupportRule" retrievable="true" baseType="FHIR.DomainResource">
        <ns4:element name="moduleMetadata" type="FHIR.ModuleMetadata"/>
        <ns4:element name="library" type="list&lt;FHIR.Reference&gt;"/>
        <ns4:element name="trigger" type="list&lt;FHIR.TriggerDefinition&gt;"/>
        <ns4:element name="condition" type="FHIR.string"/>
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="FHIR.Claim" retrievable="true" baseType="FHIR.DomainResource" primaryCodePath="subType">
        ...
        <ns4:element name="accidentLocationReference" type="FHIR.Reference"/>
        <ns4:element name="interventionException" type="list&lt;FHIR.Coding&gt;"/>
        <ns4:element name="onset" type="list&lt;FHIR.Claim.Onset&gt;"/>
        <ns4:element name="employmentImpacted" type="FHIR.Period"/>
        <ns4:element name="hospitalization" type="FHIR.Period"/>
        <ns4:element name="item" type="list&lt;FHIR.Claim.Item&gt;"/>
        <ns4:element name="total" type="FHIR.Money"/>
        <ns4:element name="additionalMaterial" type="list&lt;FHIR.Coding&gt;"/>
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="FHIR.ParticipantType" retrievable="false" baseType="FHIR.Element">
        <ns4:element name="value" type="System.String"/>
    </ns4:typeInfo>
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="FHIR.ActionRelationshipAnchor" retrievable="false" baseType="FHIR.Element">
        <ns4:element name="value" type="System.String"/>
    </ns4:typeInfo>
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="FHIR.ModuleDefinition.Library" retrievable="false" baseType="FHIR.BackboneElement">
        <ns4:element name="name" type="FHIR.string"/>
        <ns4:element name="identifier" type="FHIR.string"/>
        <ns4:element name="version" type="FHIR.string"/>
        <ns4:element name="documentAttachment" type="FHIR.Attachment"/>
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="FHIR.Parameters" retrievable="true" baseType="FHIR.Resource">
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="FHIR.Protocol.Detail" retrievable="false" baseType="FHIR.BackboneElement">
        ...
        <ns4:element name="location" type="FHIR.Reference"/>
        <ns4:element name="performer" type="list&lt;FHIR.Reference&gt;"/>
        <ns4:element name="product" type="FHIR.Reference"/>
        <ns4:element name="quantity" type="FHIR.SimpleQuantity"/>
        <ns4:element name="description" type="FHIR.string"/>
    </ns4:typeInfo>
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="FHIR.ModuleDefinition.ValueSet" retrievable="false" baseType="FHIR.BackboneElement">
        <ns4:element name="name" type="FHIR.string"/>
        <ns4:element name="identifier" type="FHIR.string"/>
        <ns4:element name="version" type="FHIR.string"/>
        <ns4:element name="codeSystem" type="list&lt;FHIR.string&gt;"/>
    </ns4:typeInfo>
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="FHIR.ActionDefinition.Behavior" retrievable="false" baseType="FHIR.Element">
        <ns4:element name="type" type="FHIR.Coding"/>
        <ns4:element name="value" type="FHIR.Coding"/>
    </ns4:typeInfo>
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="FHIR.GuidanceResponse.Behavior" retrievable="false" baseType="FHIR.BackboneElement">
        <ns4:element name="type" type="FHIR.Coding"/>
        <ns4:element name="value" type="FHIR.Coding"/>
    </ns4:typeInfo>
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="FHIR.Library.ValueSet" retrievable="false" baseType="FHIR.BackboneElement">
        <ns4:element name="name" type="FHIR.string"/>
        <ns4:element name="identifier" type="FHIR.string"/>
        <ns4:element name="version" type="FHIR.string"/>
        <ns4:element name="codeSystem" type="list&lt;FHIR.string&gt;"/>
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="FHIR.ActionDefinition.RelatedAction" retrievable="false" baseType="FHIR.Element">
        <ns4:element name="actionIdentifier" type="FHIR.Identifier"/>
        <ns4:element name="relationship" type="FHIR.ActionRelationshipType"/>
        <ns4:element name="offsetQuantity" type="FHIR.Duration"/>
        <ns4:element name="offsetRange" type="FHIR.Range"/>
        <ns4:element name="anchor" type="FHIR.ActionRelationshipAnchor"/>
    </ns4:typeInfo>
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="FHIR.Library.Model" retrievable="false" baseType="FHIR.BackboneElement">
        <ns4:element name="name" type="FHIR.string"/>
        <ns4:element name="identifier" type="FHIR.string"/>
        <ns4:element name="version" type="FHIR.string"/>
    </ns4:typeInfo>
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="FHIR.Bundle" retrievable="true" baseType="FHIR.Resource">
    ...
    <ns4:typeInfo xsi:type="ns4:ClassInfo" name="FHIR.ActionType" retrievable="false" baseType="FHIR.Element">
        <ns4:element name="value" type="System.String"/>
    </ns4:typeInfo>

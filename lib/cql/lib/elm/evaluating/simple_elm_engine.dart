...
//             _stringsEqual(left.value!, right?.value));
//   }
...
//     return decimalsEqual(left.value, right.value) &&
//         _stringsEqual(left.getUnit(), right.getUnit());
//   }

//   bool stringsEqualExpressions(Expression? left, Expression? right) {
//     return expressionsEqual(left, right);
//   }
...
//     if (left is ToList) {
//       if (right is ToList) {
//         Expression leftSingleton = (left).operand;
//         Expression rightSingleton = (right).operand;
...
//         InCodeSystem leftArg = left;
//         InCodeSystem rightArg = right;
...
//         AnyInCodeSystem leftArg = left;
//         AnyInCodeSystem rightArg = right;
...
//         InValueSet leftArg = left;
//         InValueSet rightArg = right;
//         return expressionsEqual(leftArg.code, rightArg.code) &&
...
//         AnyInValueSet leftArg = left;
//         AnyInValueSet rightArg = right;
//         return expressionsEqual(leftArg.codes, rightArg.codes) &&
//             valueSetsEqual(leftArg.valueset, rightArg.valueset) &&
//             expressionsEqual(
//                 leftArg.valuesetExpression, rightArg.valuesetExpression);
...
//         CalculateAge leftArg = left;
//         CalculateAge rightArg = right;
...
//         Subsumes leftArg = left;
//         Subsumes rightArg = right;
...
//         SubsumedBy leftArg = left;
//         SubsumedBy rightArg = right;
//         if (operandsEqual(leftArg, rightArg)) {
//           return true;
//         }
//         return false;
...
//         AggregateExpression leftArg = left;
//         AggregateExpression rightArg = right;
...
//         OperatorExpression leftArg = left;
//         OperatorExpression rightArg = right;
...
//         AliasRef leftArg = left;
//         AliasRef rightArg = right;
...
//           return false;
//         }
//         if (leftArg.caseItem.length == rightArg.caseItem.length) {
...
//     if (left is Current) {
//       if (right is Current) {
//         Current leftArg = left;
//         Current rightArg = right;
...
//         FunctionRef leftArg = left;
//         FunctionRef rightArg = right;
...
//         ExpressionRef leftArg = left;
//         ExpressionRef rightArg = right;
//         return stringsEqual(leftArg.libraryName, rightArg.libraryName) &&
//             stringsEqual(leftArg.name, rightArg.name);
//       }
//       return false;
...
//     if (left is ForEach) {
//       if (right is ForEach) {
//         ForEach leftArg = left;
//         ForEach rightArg = right;
//         return expressionsEqual(leftArg.source, rightArg.source) &&
...
//         IdentifierRef leftArg = left;
//         IdentifierRef rightArg = right;
//         return stringsEqual(leftArg.libraryName, rightArg.libraryName) &&
//             stringsEqual(leftArg.name, rightArg.name);
//       }
//       return false;
...
//         Instance leftArg = left;
//         Instance rightArg = right;
...
//         Iteration leftArg = left;
//         Iteration rightArg = right;
//         return stringsEqual(leftArg.scope, rightArg.scope);
//       }
//       return false;
//     }
...
//         MaxValue leftArg = left;
//         MaxValue rightArg = right;
...
//         MinValue leftArg = left;
//         MinValue rightArg = right;
//         return qnamesEqual(leftArg.valueType, rightArg.valueType);
//       }
//       return false;
//     }
...
//         OperandRef leftArg = left;
//         OperandRef rightArg = right;
//         return stringsEqual(leftArg.name, rightArg.name);
//       }
//       return false;
//     }
...
//         Property leftArg = left;
//         Property rightArg = right;
//         return stringsEqual(leftArg.scope, rightArg.scope) &&
...
//         TimeOfDay leftArg = left;
//         TimeOfDay rightArg = right;
...
//       CanConvert leftArg = left;
//       CanConvert rightArg = right;
...
//         DateTimeComponentFrom leftArg = left;
//         DateTimeComponentFrom rightArg = right;

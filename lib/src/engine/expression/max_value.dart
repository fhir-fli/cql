...
class MaxValue extends CqlExpression {
  ...
  factory MaxValue.fromJson(Map<String, dynamic> json) => MaxValue(
        valueType: QName.parse(json['valueType']! as String),
  ...
  static dynamic maxValue(String type) {
    switch (type) {
      case 'CqlInteger':
      case 'Integer':
        return CqlInteger(2147483647);
      case 'CqlLong':
      case 'Long':
        return CqlLong.fromString('9223372036854775807');
      case 'CqlDecimal':
      case 'Decimal':
      ...
      case 'CqlDate':
      case 'Date':
        return CqlDate.fromUnits(year: 9999, month: 12, day: 31);
      case 'CqlDateTime':
      case 'DateTime':
        return CqlDateTime.fromString('9999-12-31T23:59:59.999');
      case 'CqlTime':
      case 'Time':

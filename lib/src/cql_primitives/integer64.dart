...
class CqlLong extends CqlPrimitive implements Comparable<CqlLong> {
  ...
  CqlLong? operator ~/(dynamic other) => _op(other, (a, b) => a ~/ b);
  CqlLong? operator %(dynamic other) => _op(other, (a, b) => a % b);
  CqlLong? operator -() => valueBigInt == null ? null : CqlLong(-valueBigInt!);
  ...
  CqlLong? abs() => valueBigInt == null ? null : CqlLong(valueBigInt!.abs());
  CqlLong? gcd(dynamic other) => _op(other, (a, b) => a.gcd(b));
  CqlLong? pow(int exp) =>
      valueBigInt == null ? null : CqlLong(valueBigInt!.pow(exp));
  CqlLong? remainder(dynamic other) => _op(other, (a, b) => a.remainder(b));
  CqlLong? toUnsigned(int width) =>
      valueBigInt == null ? null : CqlLong(valueBigInt!.toUnsigned(width));
